import{B as b}from"./Layout-DfGkbYfY.js";import"./jsx-runtime-DWbWqHZ-.js";import"./index-l2PZgWEW.js";import"./assertThisInitialized-BSDNMsTW.js";import"./index-BtTJd_qj.js";const x={title:"components/ui/button",component:b,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{},args:{label:"ボタン表示名",onClick:()=>{console.log("onClick event")}}},r={name:"プライマリーボタン",parameters:{docs:{description:{story:"次の画面へ遷移するアクションを含むボタン"}}},args:{}},e={name:"セカンダリーボタン",parameters:{docs:{description:{story:"プライマリーボタンに比べると重要度が低いアクションを含むボタン"}}},args:{type:"secondary"}},s={name:"ターシャリーボタン",parameters:{docs:{description:{story:"セカンダリーボタンに比べると重要度が低いアクションを含むボタン"}}},args:{type:"other"}},a={name:"非活性",parameters:{docs:{description:{story:"非活性ボタン"}}},args:{disabled:!0}};var n,o,t;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  name: 'プライマリーボタン',
  parameters: {
    docs: {
      description: {
