import{B as u}from"./Text-DlwGEEm7.js";import"./assertThisInitialized-CGz1coAQ.js";import"./index-l2PZgWEW.js";import"./index-BtTJd_qj.js";const S={title:"components/Button",component:u,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{},args:{id:"demo",label:"ボタン表示名",onClick:()=>{}}},r={parameters:{docs:{description:{story:"プライマリーボタン：次の画面へ遷移するアクションを含むボタン"}}},args:{}},e={parameters:{docs:{description:{story:"セカンダリーボタン：プライマリーボタンに比べると重要度が低いアクションを含むボタン"}}},args:{type:"secondary"}},s={parameters:{docs:{description:{story:"非活性ボタン"}}},args:{disabled:!0}};var a,o,t;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
